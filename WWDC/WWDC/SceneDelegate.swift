...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        window?.frame = myScene.coordinateSpace.bounds
...
//          firstVc.tabBarItem.title = "iOS15"
      
        let secondVC = UINavigationController(rootViewController: SecondViewController())
      secondVC.tabBarItem.image = UIImage(systemName: "paperplane")
//          secondVC.tabBarItem.title = "iOS16"
